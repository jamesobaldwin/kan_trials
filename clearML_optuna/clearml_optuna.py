...
def main():   
    ...
    optimizer = HyperParameterOptimizer(
        ...
        hyper_parameters=[
            ...
            UniformIntegerParameterRange('General/m1_0', min_value=1, max_value=4),
            UniformIntegerParameterRange('General/a1_1', min_value=0, max_value=4),
            UniformIntegerParameterRange('General/m1_1', min_value=1, max_value=4),
            UniformIntegerParameterRange('General/a1_2', min_value=0, max_value=4),
            UniformIntegerParameterRange('General/m1_2', min_value=1, max_value=4),
            UniformIntegerParameterRange('General/a2_0', min_value=0, max_value=4),
            UniformIntegerParameterRange('General/m2_0', min_value=1, max_value=4),
            UniformIntegerParameterRange('General/a2_1', min_value=0, max_value=4),
            UniformIntegerParameterRange('General/m2_1', min_value=1, max_value=4),
            UniformIntegerParameterRange('General/a2_2', min_value=0, max_value=4),
            UniformIntegerParameterRange('General/m2_2', min_value=1, max_value=4),
